...
const MobileNav: React.FC<MobileNavProps> = ({ currentView, onChangeView }) => {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-slate-900/95 backdrop-blur-lg border-t border-slate-800 z-40 pb-safe">
